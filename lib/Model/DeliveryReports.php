...
/**
 * DeliveryReports Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     MessageMedia\RESTAPI
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DeliveryReports implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryReports';
    ...
    protected static $swaggerTypes = array(
        'delivery_reports' => '\MessageMedia\RESTAPI\Model\DeliveryReport[]'
    );
    ...
    {
        $this->container['delivery_reports'] = isset($data['delivery_reports']) ? $data['delivery_reports'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delivery_reports'] === null) {
            $invalid_properties[] = "'delivery_reports' can't be null";
        }
     ...
     * @return \MessageMedia\RESTAPI\Model\DeliveryReport[]
     */
     ...
     * @param \MessageMedia\RESTAPI\Model\DeliveryReport[] $delivery_reports The oldest 100 unconfirmed delivery reports.
     * @return $this
     */
